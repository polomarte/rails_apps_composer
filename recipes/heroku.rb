...
stage_three do
  ...
  gsub_file 'config/application.yml', "{{dev_mailtrap_user}}", "#{prefs[:dev_mailtrap_user]}"
  gsub_file 'config/application.yml', "{{dev_mailtrap_password}}", "#{prefs[:dev_mailtrap_password]}"
  gsub_file 'config/application.yml', "{{dev_secret_key}}", "#{prefs[:dev_secret_key]}"

  gsub_file 'config/application.yml', "{{test_secret_key}}", "#{prefs[:test_secret_key]}"

  gsub_file 'config/application.yml', "{{staging_host}}", "#{prefs[:staging_host]}"
  gsub_file 'config/application.yml', "{{staging_fog_dir}}", "#{prefs[:staging_fog_dir]}"
  gsub_file 'config/application.yml', "{{staging_mailtrap_user}}", "#{prefs[:staging_mailtrap_user]}"
  gsub_file 'config/application.yml', "{{staging_mailtrap_pwd}}", "#{prefs[:staging_mailtrap_pwd]}"
  gsub_file 'config/application.yml', "{{staging_secret_key}}", "#{prefs[:staging_secret_key]}"

  gsub_file 'config/application.yml', "{{prod_host}}", "#{prefs[:prod_host]}"
  gsub_file 'config/application.yml', "{{prod_fog_dir}}", "#{prefs[:prod_fog_dir]}"
  gsub_file 'config/application.yml', "{{prod_mailtrap_user}}", "#{prefs[:prod_mailtrap_user]}"
  gsub_file 'config/application.yml', "{{prod_mailtrap_pwd}}", "#{prefs[:prod_mailtrap_pwd]}"
  gsub_file 'config/application.yml', "{{prod_secret_key}}", "#{prefs[:prod_secret_key]}"
